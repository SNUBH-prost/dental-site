...
const SOAP_SEED_VERSION = 4; // 시드 콘텐츠 버전 — 올리면 기존 시드 항목이 새 내용으로 교체됨
...
const SOAP_SEED = [
  // ── 1. 고정성 보철 (Crown & Bridge) ──
  {
    ...
    subjective: '- **주소(C.C.)**: 환자 표현 그대로 + 발생 시점·악화/완화 요인\n- **치과력**: 과거 보철·근관·치주 치료와 기존 수복물 실패 원인\n- **의과력**: 당뇨, **항흡수제/비스포스포네이트(MRONJ)**, 항응고제, 두경부 방사선, 금속 알레르기\n- **습관·기대치**: bruxism/clenching, 흡연, 심미 요구·비용·시간 제약',
    objective: '- **진단 자료**: 교합기 마운팅 진단모형, 파노라마 + 지대치 PA, 규격 사진, **diagnostic wax-up**, 필요 시 CBCT\n- **교합 분석**: VDO, **CR–CO 편위**(방향·양), 유도양식(canine guidance / group function), 조기접촉·간섭\n- **지대치별**: 잔존 치질, **ferrule(높이 <mark style="background:#fef08a">≥1.5~2 mm</mark>·두께 ≥1 mm) 확보 여부**, 치수 생활력·PA, C:R ratio, 치주(probing·동요도)',
    assessment: '- 진단명·원인, **개별 치아 예후**(good/fair/poor/hopeless)\n- **설계·재료 결정** — 아래 생존율 근거로 선택\n- **ACP PDI**(부분무치악 Class I~IV)로 난이도·의뢰 필요성 층화\n\n<details><summary>🔬 재료별 생존율 (Sailer &amp; Pjetursson, 2015)</summary>\n\n5년 생존율 — **단관**: 금속도재(MCC) 94.7% · 리튬디실리케이트 96.6% · 지르코니아 91.2%(실패의 다수가 도재 chipping). **FPD**: MCC 94.4% vs 전부도재 88.6% (P&lt;0.0001), 10년 MCC FPD ≈ 89~90%.\n→ 전치 단관은 glass-ceramic이 심미·생존 모두 우수, **응력·장경간 FPD·bruxer는 MCC / 모놀리식 지르코니아** 우선. (Sailer 2015; Pjetursson 2015, *Dent Mater*)\n\n</details>',
    plan: '- 순차 계획(전처치 → 임시 → 최종) + **대안 제시**(무처치·임플란트·가철성)\n- **Informed consent**: 이득·위험·대안·비용·예후 문서화\n- 다음 예약(형성)\n\n<details><summary>🔬 근거 — ferrule</summary>\n\n연속적인 1.5~2 mm 치질 ferrule은 post-core 수복치의 파절 저항을 유의하게 높인다(Sorensen &amp; Engelman, *JPD* 1990; SR: Juloski, *J Endod* 2012). **부분(협측만) ferrule은 예측성이 낮아** crown lengthening / 교정적 정출을 선행 고려.\n\n</details>',
  },
  {
    title: '고정성 1-2 · 지대치 형성 및 임시보철',
    category: '고정성', order: 2,
    subjective: '- 지난 내원 후 증상(자발통·냉온), 치료 범위·비용 **동의 재확인**',
    objective: '- **마취**(약제/용량/부위)\n- **삭제량(재료별 최소)** —\n<dl><dt>지르코니아(모놀리식)</dt><dd>교합 1.0~1.5 · 축면 0.5~1.0 mm</dd><dt>리튬디실리케이트</dt><dd>교합 1.5~2.0 · 축면 1.0~1.5 mm</dd><dt>PFM</dt><dd>교합/순면 1.5~2.0 mm</dd><dt>전부금속</dt><dd>기능교두 1.5 · 비기능 1.0 mm</dd></dl>\n- **형성**: undercut 무, 명확·연속 finish line(chamfer=지르코니아·금 / rounded shoulder=도재), **total occlusal convergence(TOC)** 목표 <mark style="background:#fef08a">10~20°</mark>\n- **Margin**: 가능하면 치은연상 — supracrestal attachment 침범 금지\n- **Provisional**(bis-acryl): contact·margin·occlusion·emergence 형성, 비유게놀 임시접착(최종이 레진접착 시)\n- **Shade**: 탈수 전 채득',
    assessment: '- 삭제량·convergence·마진 연속성 적절, ferrule 확보, 임시보철 acceptable',
    plan: '- 다음 예약(정밀인상), 지각과민·임시보철 관리 지침\n\n<details><summary>🔬 근거 — taper와 생물학적 폭경</summary>\n\n**Taper**: 이상적 6°는 이론치(Jørgensen 1955)이며, **임상 권장은 TOC 10~20°**(Goodacre, *JPD* 2001) — 실제 달성치는 흔히 15~27°. 6°에 집착해 undercut·과삭제를 만들지 말 것.\n\n**생물학적 폭경**: 평균 2.04 mm(접합상피 0.97 + 결합조직 1.07; Gargiulo, *J Periodontol* 1961)이나 개인차가 크다. 변연을 치은연하로 둘 땐 **변연–치조골 ≥3 mm** 확보(Nevins; Padbury, *JCP* 2003) — 미확보 시 crown lengthening. 침범하면 만성 염증·부착소실·퇴축.\n\n</details>',
  },
  {
    title: '고정성 1-3 · 정밀인상 및 악간관계 채득',
    category: '고정성', order: 3,
    subjective: '- 임시보철 사용감(불편·지각과민·탈락), 심미 중간 피드백',
    objective: '- 임시보철 제거, 지대치·변연 치은 확인(염증 시 인상 연기)\n- **치은압배 2-cord**: 1st(가는 것·지혈) → 2nd(굵은 것·측방 압배) → 2nd 제거 직후 인상\n- **정밀인상**: <u>PVS</u>/polyether 또는 **구강스캐너**; 전둘레 마진 인기 확대 확인\n- **대합 인상 + bite(CR 또는 MIP)**, 필요 시 facebow\n- **기공지시서**: 재료·shade(사진 첨부)·마진·occlusal scheme·납기',
    assessment: '- 압배 충분, 인상 정밀(기포·당김·미인기 없음), 전둘레 마진 확인',
    plan: '- 기공 의뢰, 다음 예약\n\n<div class="tip"><b>💡 보철과 디테일</b>최종이 레진접착이면 압배 지혈이 곧 접착 성공을 좌우합니다. 삼출·출혈이 있으면 인상뿐 아니라 접착까지 실패하므로 이 단계에서 완전 지혈을 확보하세요.</div>',
  },
  {
    title: '고정성 1-4 · 시적 (Framework / Bisque Try-in)',
    category: '고정성', order: 4,
    subjective: '- 임시보철 경과, 심미 기대 재확인',
    objective: '- **하부구조 적합**: marginal fit(explorer·확대), internal fit(fit-checker), **rocking 여부**\n- **인접 접촉**(floss·shimstock), **교합**(paper로 CO 균등·편심 간섭)\n- (bisque 단계) 심미·발음, **환자 확인·서면 동의**',
    assessment: '- 하부구조 수동적 적합, 변연 허용치 내, 접촉·교합 acceptable / 수정 항목 특정',
    plan: '- 기공 재의뢰(glaze·수정), 다음 예약(장착)\n\n<details><summary>🔬 근거 — 변연 적합 기준</summary>\n\n임상 허용 marginal gap은 고전적으로 <mark style="background:#fef08a">&lt;120 μm</mark>(McLean &amp; von Fraunhofer, *Br Dent J* 1971 — in vivo ~1,000개 관찰). 이는 역사적 임상 기준으로, **현대 CAD/CAM in-vitro 목표치는 더 엄격(≤75~100 μm)**. 간격이 클수록 시멘트 용해·미세누출·이차우식 위험 증가.\n\n</details>',
  },
  {
    title: '고정성 1-5 · 최종 장착 및 종결',
    category: '고정성', order: 5,
    subjective: '- 임시보철 경과, 최종 심미 확인',
    objective: '- 임시보철·임시시멘트 완전 제거, 건조\n- **적합**(fit-checker), **contact**(floss/shimstock), **occlusion**(CO 균등 · excursion 간섭 제거)\n- **접착 — 재료별** —\n<dl><dt>지르코니아</dt><dd>알루미나 블라스트 + <u>MDP 프라이머</u> → 레진/자가접착 시멘트</dd><dt>리튬디실리케이트</dt><dd>HF 4~5% + silane → 레진시멘트(광/이중중합)</dd><dt>금속·유지형태 충분</dt><dd>RMGI / GI</dd></dl>\n- 방습, 안착 하 경화, **잉여 시멘트 완전 제거**, **Final PA**로 잔사 확인',
    assessment: '- 적합·접촉·교합·심미 양호, 완전 안착',
    plan: '- 저작 적응·치실·야간 가드(bruxer) 지침, **6~12개월 리콜**\n\n<div class="danger"><b>🚫 역효과 주의</b>치은연하 잉여 레진시멘트 잔존은 만성 염증·이차우식·부착소실의 흔한 원인. 접착 전 인접부에 치실을 통과시켜 두고 경화 후 방사선으로 잔사를 확인하세요.</div>',
  },
  ...
  // ── 2. 국소의치 (RPD) ──
  {
    ...
    subjective: '- 주소, 결손 부위·기간, 기존 의치 경험, 손재주(착탈 능력), 기대치',
    objective: '- Alginate 예비인상 → 진단모형\n- **진단 서베잉**: 착탈로 결정, undercut 위치·깊이 계측(표준 게이지 <mark style="background:#fef08a">0.25 mm(0.01")</mark>), guide plane·심미 클래스프 위치\n- **분류**: <u>Kennedy + Applegate 규칙</u>, 대합·잔존치 분포·치주·동요도, 잔존 치조제',
    assessment: '- Kennedy Class(I~IV) + modification, **지지 형태**(치아지지 / 유리단 혼합지지)\n- **설계 4요소**(지지 rest · 유지 retainer · 안정 · 연결 connector), 지대치 예후',
    plan: '- 구강 형성 계획(rest seat·guide plane·surveyed crown 부위), 다음 예약\n\n<details><summary>🔬 근거 — RPD가 지대치에 주는 위험</summary>\n\nRPD 장착은 지대치·잔존치의 **치태 축적↑ → 우식·치주 위험을 높인다**(장기 코호트: 위생 관리가 부실하면 지대치 상실률 유의 증가). 따라서 rest·guide plane로 응력을 축방향화하고, **철저한 위생·정기 리콜을 설계의 일부로** 포함해야 한다. 유리단(Kennedy I·II)은 점막 피압축성 차이로 원칙이 근본적으로 다르다 → altered cast 개념의 출발점.\n\n</details>',
  },
  {
    title: 'RPD 2-2 · 구강 형성 (Mouth Preparation)',
    category: '국소의치', order: 2,
    subjective: '- 특이사항, 지난 내원 후 증상',
    objective: '- 마취(해당 시)\n- **Guiding plane**: 지대치 인접면을 착탈로에 평행하게 삭제(2~4 mm) — 착탈로 일치·유지·안정\n- **Rest seat**: occlusal rest(spoon 형태, 바닥이 치아 장축으로 응력 전달), cingulum/incisal rest\n- 필요 시 **surveyed crown** 형성·인상(guide plane·rest seat·undercut 부여)',
    assessment: '- rest seat 형태·깊이 적절(축방향 응력), guide plane 평행·연속',
    plan: '- 정밀인상 계획, 다음 예약\n\n<div class="warning"><b>⚠️ 주의</b>rest seat 바닥 경사가 잘못되면 지대치에 측방력이 걸려 동요·상실을 유발합니다. 바닥은 치아 장축을 향해 응력이 전달되도록 형성하세요.</div>',
  },
  {
    title: 'RPD 2-3 · 정밀인상 (Final Impression)',
    category: '국소의치', order: 3,
    subjective: '- 특이사항',
    objective: '- **개인트레이** 제작·시적, 변연 조정\n- 필요 시 border molding, rubber(PVS/polyether) 정밀인상\n- **유리단(Kennedy I·II)**: <u>altered cast 기법</u> — framework 제작 후 유리단만 기능인상 재채득',
    assessment: '- 변연·지지부·잔존치 인기 정밀, 유리단 조직 지지 확보',
    plan: '- framework 제작 의뢰(설계도 첨부), 다음 예약\n\n<details><summary>🔬 근거 — altered cast</summary>\n\n유리단은 원심으로 갈수록 피압축성이 큰 점막에만 지지된다. 해부학적 인상만으로 만들면 저작 시 의치가 조직 쪽으로 침하하며 지대치에 지렛대(torque)가 걸린다. altered cast(McCracken)는 유리단을 기능 부하 상태로 인기해 지지를 넓히고 지대치 응력을 줄인다.\n\n</details>',
  },
  {
    title: 'RPD 2-4 · 금속 주조체 시적 (Framework Try-in)',
    category: '국소의치', order: 4,
    subjective: '- 특이사항, 착용 시 압박·통증',
    objective: '- **적합**: disclosing wax/fit-checker로 rest·connector·retainer 접촉\n- **Passive fit**: 손가락 압력 없이 완전 안착, **rocking 무**, rest 완전 착좌\n- 클래스프 유지 tip이 계측된 undercut에 위치, 대합 간섭 제거',
    assessment: '- framework 수동적 적합, rest 완전 안착, **rocking 없음**',
    plan: '- bite record / 인공치 배열 단계, 다음 예약\n\n<div class="warning"><b>⚠️ 주의</b>rocking하거나 rest가 뜨면 배열로 넘어가지 마세요. 원인(조기접촉·주조 변형·모형 오차)을 먼저 해결 — 이 단계 부적합은 완성 의치의 유지 상실·지대치 손상으로 직결됩니다.</div>',
  },
  {
    title: 'RPD 2-5 · 악간관계 채득 및 납의치 시적',
    category: '국소의치', order: 5,
    subjective: '- 환자 심미 피드백(치아 형태·색·배열)',
    objective: '- **Record base + wax rim**(framework 위)으로 VDO·CR, facebow\n- 인공치 선택(mold·shade)\n- **Wax try-in**: 정중선·순측 지지·smile line, 발음(F/V=절단연, S=수직공간), 교합(잔존치 조화), **환자 승인 서면화**',
    assessment: '- VDO·CR·심미·교합·발음 acceptable, 환자 동의',
    plan: '- 온성(processing) 의뢰, 다음 예약(장착)',
  },
  {
    title: 'RPD 2-6 · 의치 장착 및 조정',
    category: '국소의치', order: 6,
    subjective: '- (재내원) 통증 부위, 유지·저작·발음 호소',
    objective: '- 장착, **PIP**로 과압박점 조정, **disclosing wax**로 변연 조정\n- **Clinical remount** 후 CO 균등·편심 조정, 클래스프 유지력 미세조정, 착탈·세척·야간 제거 교육',
    assessment: '- 적합·유지·안정·교합 양호, 압박점 해소',
    plan: '- **24~48시간 후 1차 조정**, sore spot 소실까지 3~4회, 정기 리콜(연 1회)·이장 안내',
  },
  ...
  // ── 3. 총의치 (Complete Denture) ──
  {
    ...
    subjective: '- 주소, 무치악 기간·기존 의치 불만, 병력, 적응력·기대치',
    objective: '- Stock tray + alginate/compound → 진단모형 → **개인트레이 제작**\n- **평가**: 치조제 형태·흡수도, 점막(flabby/undercut), 구개·소대 부착, 개구량, 타액, 상순 지지',
    assessment: '- **분류**: ACP PDI(완전무치악 I~IV), 하악 흡수도\n- 지지·유지·안정 예후, 어려운 해부(심한 흡수·flabby·건조) 예고',
    plan: '- 개인트레이 제작, 다음 예약\n\n<details><summary>🔬 근거 — 치조제 흡수 (Tallgren)</summary>\n\n무치악 치조제는 발치 후 **첫 해에 급속 흡수 후 완만해진다(~0.1~0.2 mm/yr)**. **하악 전방이 상악의 약 4배** 속도로 흡수(Tallgren, *JPD* 1972, 25년 종단). → 지지가 불리해질 것을 전제로 설계하고 정기 이장·재제작을 예고할 것.\n\n</details>',
  },
  {
    title: 'CD 3-2 · 정밀인상 (Final Impression)',
    category: '총의치', order: 2,
    subjective: '- 특이사항, 개인트레이 착용감',
    objective: '- 개인트레이 시적·조정(vestibule 1~2 mm short)\n- **Border molding**(green-stick / PVS heavy)으로 근육 부착·기능운동 반영\n- **최종인상**: light-body PVS/ZOE/polyether — 상악 **post-dam** 설정, 하악 retromolar pad·buccal shelf 지지\n- flabby ridge는 **선택적 무압인상**',
    assessment: '- 변연 폐쇄·신장 적절, 지지영역 정확(과압박 없음)',
  ...
  },
  {
    ...
    subjective: '- 특이사항',
    objective: '- **Occlusal rim**: 순측 지지·교합평면(Camper’s plane / 동공간선 평행)\n- **VDO**: 안모·발음·연하 + **freeway space**(안정위 − 교합위 = <mark style="background:#fef08a">2~4 mm</mark>)\n- **CR**: Gothic arch tracer 또는 bimanual/swallowing, **facebow**, 인공치 선택(mold·shade)',
    assessment: '- VDO 적절(과고 → 저작통·clicking·흡수 가속 / 과저 → 심미·효율 저하), CR 재현 가능',
    plan: '- 인공치 배열·wax try-in, 다음 예약\n\n<div class="warning"><b>⚠️ 주의</b>VDO 과고경은 freeway space를 없애 저작통·구각염·치조제 흡수 가속을 부릅니다. 안정위에서 2~4 mm 여유를 반드시 확보하세요.</div>',
  },
  {
    title: 'CD 3-4 · 납의치 시적 (Wax Try-in)',
    category: '총의치', order: 4,
    subjective: '- 심미 피드백(치아·잇몸 색, 배열, 노출량)',
    objective: '- **VDO·CR 재검증**, lip support·정중선·smile line·buccal corridor\n- **발음**: F/V(절단연-하순), S(전방·수직 공간, 휘슬 없이)\n- **교합**: 교합양식 결정(아래 근거), **환자 승인 서면화**',
    assessment: '- 심미·발음·교합·VDO acceptable, 환자 동의',
    plan: '- 온성, 다음 예약(장착)\n\n<details><summary>🔬 근거 — 총의치 교합양식</summary>\n\nbalanced · lingualized · canine-guided 간 **만족도·저작능의 우열은 결정적 근거가 없다**(체계적 고찰의 고찰: Pisani, *JPD* 2022). 다만 **셋 다 monoplane보다는 우수**하고, **흡수가 심한 치조제에서는 lingualized가 완만한 이점**을 보인다(안정·저작). → 잔존제 상태에 맞춰 선택.\n\n</details>',
  },
  {
    title: 'CD 3-5 · 의치 장착 및 종결',
    category: '총의치', order: 5,
    subjective: '- (재내원) 통증·유지·저작·발음',
    objective: '- 내면 적합(**PIP**), 변연 조정, **clinical remount**로 교합 정밀 조정(processing 오차 보정)\n- 유지·흡착·교합 확인, 착탈·세척·보관(야간 제거) 교육',
    assessment: '- 유지·적합·교합 양호',
    plan: '- **리콜 24시간 → 1주**로 sore spot relief 완결 후 종결, 연 1회 점검·이장 안내\n\n<div class="tip"><b>💡 보철과 디테일</b>acrylic 중합 수축으로 온성 후 교합이 미세하게 어긋납니다. 구내 조정만으론 한계가 있어 <u>clinical remount</u>가 균형교합 완성의 핵심입니다.</div>',
  },
  ...
  // ── 4. 임플란트 보철 (Implant Prosthetics) ──
  {
    ...
    objective: '- **골유착 확인**: percussion, 방사선 marginal bone level, 필요 시 ISQ\n- **Healing abutment** → **cuff/emergence 형성 2~3주**\n- 각화점막 폭(<2 mm면 연조직 이식 고려), 인접·대합 관계',
    assessment: '- 골유착 양호, 연조직 성숙 대기',
    plan: '- 인상 예약(2~3주 후)\n\n<details><summary>🔬 근거 — 임플란트 성공 기준</summary>\n\nAlbrektsson 등(*IJOMI* 1986): 동요·투과대 없음, **첫 1년 이후 연간 변연골 소실 <mark style="background:#fef08a">&lt;0.2 mm</mark>**. (첫 해 remodeling은 원논문상 ~1.0~1.2 mm — 흔히 1.5 mm로 오인용되니 주의.) ICOI Pisa 합의(Misch, *Implant Dent* 2008)는 단일 pass/fail이 아닌 **success / satisfactory·compromised survival / failure의 4단계 건강척도**로 재정의.\n\n</details>',
  },
  {
    title: '임플란트 4-2 · 인상 채득 (Impression)',
    category: '임플란트', order: 2,
    subjective: '- 특이사항',
    objective: '- **인상**: pick-up(open tray, 다수·비평행 유리) / transfer(closed) / **scan body 디지털**\n- **인상코핑 완전 안착을 방사선으로 확인**(mismatch = 전체 부정합)\n- custom abutment 설계(emergence·margin 위치·각도), 대합 인상, shade',
    assessment: '- 인상코핑 안착·연조직·대합 양호',
    plan: '- custom abutment/crown 제작 의뢰, 다음 예약\n\n<div class="warning"><b>⚠️ 주의</b>인상코핑이 완전히 안착되지 않으면 보철물 전체가 부정합이 되어 나사풀림·파절·변연골 소실로 이어집니다. 육안·촉진이 아니라 <u>방사선</u>으로 안착을 확인하세요.</div>',
  },
  {
    title: '임플란트 4-3 · Abutment & Crown Try-in',
    category: '임플란트', order: 3,
    subjective: '- 특이사항',
    objective: '- **Custom abutment 적합·방향 확인 → 제조사 지정 토크 체결**(통상 <mark style="background:#fef08a">20~35 Ncm</mark>)\n- Crown **fit/contact/occlusion**, **방사선으로 완전 안착 확인**\n- **교합 확인**(아래 근거): 경교합 약접촉, 강교합에서 자연치와 균등, 측방·전방 무간섭',
    assessment: '- abutment 적합·안착, crown 적합·접촉·교합 acceptable',
    plan: '- (수정 시 재의뢰), 최종 장착 예약',
  },
  {
    title: '임플란트 4-4 · 최종 장착 및 종결',
    category: '임플란트', order: 4,
    subjective: '- 특이사항',
    objective: '- **나사유지**: 최종 토크 → **screw access sealing**(teflon + composite)\n- **시멘트유지**: margin을 얕게, **잉여 시멘트 완전 제거**(방사선 확인)\n- **교합**(implant-protected: 경하중 약접촉·측방 무접촉, ~30 μm relief), 인접 접촉, **Final PA**',
    assessment: '- 적합·교합·안착 양호, 마감 적절',
    plan: '- **유지관리 이관**: 6개월 리콜(주위 probing·방사선 골레벨·나사·교합), 전용 위생\n\n<div class="danger"><b>🚫 역효과 주의</b>시멘트유지형의 치은연하 잉여 시멘트는 peri-implant disease와 강하게 연관 — 이환 부위의 <mark style="background:#fef08a">81%</mark>에서 잉여 시멘트가 발견되고 제거 후 74%가 호전(Wilson, *J Periodontol* 2009). 심부 마진이 불가피하면 나사유지형/맞춤 abutment로 마진을 얕게 올리세요.</div>\n\n<details><summary>🔬 근거 — implant-protected occlusion</summary>\n\n경하중 약접촉·측방 무접촉 원칙은 Misch &amp; Bidez의 생역학적 개념이다. 다만 **어떤 임플란트 교합양식이 생물학적/기계적 실패를 줄인다는 고수준 근거는 없다**(리뷰: Sheridan 2016; Koyano &amp; Esaki 2015) — RCT로 입증된 것이 아니라 합의·경험칙임을 이해하고 적용할 것.\n\n</details>',
  },
  ...
  // ── 5. 임시·즉시의치 (Interim / Immediate Denture) ──
  {
    ...
    objective: '- 장착 — 유형(interim RPD/flipper/치료용 의치), 재질(acrylic ± wire clasp)\n- 조정: 조직면 적합, 유지, 변연·조직 압박, **교합(조기접촉 제거)**, 심미·발음\n- (임플란트 대기) **식립부 relief** — 치유·비하중 기간 하중 회피',
    assessment: '- **잠정(임시) 보철임을 명시** + 목적(심미·공간유지·기능·적응·의문 지대치 관찰); 유지·적합은 **임시 수준 acceptable**',
    plan: '- **확정 계획·시기 기재**(치유 후 확정 RPD/임플란트/이장), 임시성·저작효율·위생 지침, informed consent, 조정 재내원',
  },
  {
    title: '임시의치 5-2 · 즉시의치 장착 (Immediate Denture)',
    category: '임시의치', order: 2,
    subjective: '- 발치·창상 자각(통증·출혈), 심미 기대',
    objective: '- 발치와 위 장착, **지혈 확인**, 필요 시 tissue conditioner/연성 이장\n- 유지·변연·교합(부종 고려한 최소 조정)',
    assessment: '- 발치와 위 장착으로 **흡수에 따른 이장이 예정된 이행기 보철**임을 명시',
    plan: '- **첫 24시간 제거 금지**(압박드레싱 역할), 다음 날 첫 제거·조정\n- 후속: **24시간 → 1주 → 1개월**, 필요 시 연성 이장\n- **이장/재제작 시기**: 흡수가 발치 후 초기(첫 6개월)에 집중 → 초기 이장은 곧 헐거워짐 → **4~6개월경 경성 이장 또는 확정 의치**(Tallgren 흡수곡선 근거)\n\n<div class="warning"><b>⚠️ 주의</b>즉시의치는 첫 24시간 제거 금지 — 이 시기가 창상 보호·지혈·부종 억제의 핵심입니다. 임의로 빼면 부종으로 재장착이 어려워집니다.</div>',
  },
];
